...
examples, expose weak reasoning, and show where human assistance improves the
result.

Can the agent distinguish routine analytics from genuine brilliance?

Can it say, "I do not know," without collapsing into vague language?

Can it identify the missing evidence, the hard subproblem, the false shortcut,
and the point where human judgment has to intervene?
...
The test is whether AI can confront serious problems without hallucinating
certainty, laundering assumptions, or replacing disciplined thought with
polished language.

If it waffles, help it.

Define the boundary. Demand the missing evidence. Ask what would falsify the
claim. Separate the analytic part from the creative leap.
